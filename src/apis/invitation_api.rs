...
pub async fn site_invitation_answer(configuration: &configuration::Configuration, params: SiteInvitationAnswerParams) -> Result<(), Error<SiteInvitationAnswerError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SiteInvitationAnswerError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn site_invitation_send(configuration: &configuration::Configuration, params: SiteInvitationSendParams) -> Result<crate::models::UserOutput, Error<SiteInvitationSendError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/site/{site_id}/invitation", local_var_configuration.base_path, site_id=crate::apis::urlencode(site_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SiteInvitationSendError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
