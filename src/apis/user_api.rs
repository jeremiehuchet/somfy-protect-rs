...
pub async fn create_user(configuration: &configuration::Configuration, params: CreateUserParams) -> Result<crate::models::UserOutput, Error<CreateUserError>> {
...
pub async fn delete_sp_data(configuration: &configuration::Configuration, params: DeleteSpDataParams) -> Result<(), Error<DeleteSpDataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteSpDataError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn send_password_token(configuration: &configuration::Configuration, params: SendPasswordTokenParams) -> Result<(), Error<SendPasswordTokenError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SendPasswordTokenError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_user_with_token(configuration: &configuration::Configuration, params: UpdateUserWithTokenParams) -> Result<(), Error<UpdateUserWithTokenError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.query(&[("security_token", &security_token.to_string())]);
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    local_var_req_builder = local_var_req_builder.json(&user);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateUserWithTokenError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn user_guest_create(configuration: &configuration::Configuration, params: UserGuestCreateParams) -> Result<crate::models::UserGuestOutput, Error<UserGuestCreateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UserGuestCreateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn user_password_set(configuration: &configuration::Configuration, params: UserPasswordSetParams) -> Result<(), Error<UserPasswordSetError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/user/{user_id}/password", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UserPasswordSetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn validate_email(configuration: &configuration::Configuration, params: ValidateEmailParams) -> Result<crate::models::ValidateEmail200Response, Error<ValidateEmailError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/user/validate-email/{email}", local_var_configuration.base_path, email=crate::apis::urlencode(email));
