...
pub struct SiteUserLinkInput {
    #[serde(rename = "geofence", skip_serializing_if = "Option::is_none")]
    pub geofence: Option<Box<crate::models::GeoFenceInput>>,
    ...
    #[serde(rename = "user_rights_granted_until_at", skip_serializing_if = "Option::is_none")]
    pub user_rights_granted_until_at: Option<String>,
}

impl SiteUserLinkInput {
    pub fn new() -> SiteUserLinkInput {
        SiteUserLinkInput {
            geofence: None,
            profiles: None,
