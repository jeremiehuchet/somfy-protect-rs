...
pub struct UserOutputWithSites {
    /// User associated sites.
    #[serde(rename = "sites", skip_serializing_if = "Option::is_none")]
    pub sites: Option<Vec<crate::models::SiteOutputWithUserRelation>>,
    #[serde(rename = "alexaSelectedSiteId", skip_serializing_if = "Option::is_none")]
    pub alexa_selected_site_id: Option<String>,
    /// User identifier.
...
impl UserOutputWithSites {
    pub fn new() -> UserOutputWithSites {
        UserOutputWithSites {
            sites: None,
            alexa_selected_site_id: None,
            user_id: None,
            created_at: None,
            activated: None,
            type_user: None,
