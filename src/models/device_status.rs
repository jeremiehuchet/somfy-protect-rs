...
pub struct DeviceStatus {
    ...
    #[serde(rename = "rlink_quality_percent", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "mfa_quality_percent", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "mfa_last_test_success_at", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "mfa_last_offline_at", skip_serializing_if = "Option::is_none")]
    pub mfa_last_offline_at: Option<String>,
    /// Last MFA connected status (AIO, AIO+, Box).
    #[serde(rename = "mfa_last_connected_at", skip_serializing_if = "Option::is_none")]
    pub mfa_last_connected_at: Option<String>,
    /// Last MFA disconnected status (AIO, AIO+, Box).
    #[serde(rename = "mfa_last_disconnected_at", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "last_shutter_opened_at", skip_serializing_if = "Option::is_none")]
    pub last_shutter_opened_at: Option<String>,
    /// Last shutter closed (AIO, AIO+, Camera).
    #[serde(rename = "last_shutter_closed_at", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "lora_quality_percent", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "lora_last_test_success_at", skip_serializing_if = "Option::is_none")]
    pub lora_last_test_success_at: Option<String>,
    /// Last LoraWan online status (AIO+, Box).
    #[serde(rename = "lora_last_online_at", skip_serializing_if = "Option::is_none")]
    pub lora_last_online_at: Option<String>,
    /// Last LoraWan offline status (AIO+, Box).
    #[serde(rename = "lora_last_offline_at", skip_serializing_if = "Option::is_none")]
    pub lora_last_offline_at: Option<String>,
    /// Last LoraWan connected status (AIO+, Box).
    #[serde(rename = "lora_last_connected_at", skip_serializing_if = "Option::is_none")]
    pub lora_last_connected_at: Option<String>,
    /// Last LoraWan disconnected status (AIO+, Box).
    #[serde(rename = "lora_last_disconnected_at", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "battery_level_state", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "last_check_in_state", skip_serializing_if = "Option::is_none")]
    pub last_check_in_state: Option<String>,
    /// Last check out from remote (Remote).
    #[serde(rename = "last_check_out_state", skip_serializing_if = "Option::is_none")]
    pub last_check_out_state: Option<String>,
    /// Is Tag recalibration required (Tag).
    #[serde(rename = "recalibration_required", skip_serializing_if = "Option::is_none")]
