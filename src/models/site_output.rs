...
pub struct SiteOutput {
    ...
    pub invitation: Box<crate::models::SiteInvitationOutput>,
    #[serde(rename = "alarm")]
    pub alarm: Box<crate::models::SiteAlarm>,
    ...
    pub services: Box<crate::models::SiteServicesOutput>,
    /// Site label.
...
impl SiteOutput {
    pub fn new(site_id: String, security_level: SecurityLevel, invitation: crate::models::SiteInvitationOutput, alarm: crate::models::SiteAlarm, restoration_active: bool, privacy_active: bool, read_only: bool, services: crate::models::SiteServicesOutput) -> SiteOutput {
        SiteOutput {
            site_id,
            security_level,
