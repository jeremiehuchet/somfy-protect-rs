...
pub struct PlanCurrent {
    ...
    pub cvr_status: Box<crate::models::PlanCvrStatus>,
    #[serde(rename = "emergency_status")]
    pub emergency_status: Box<crate::models::PlanEmergencyStatus>,
    #[serde(rename = "emergency_network_status", skip_serializing_if = "Option::is_none")]
    pub emergency_network_status: Option<Box<crate::models::PlanEmergencyNetworkStatus>>,
    #[serde(rename = "pro_monitoring_status")]
    pub pro_monitoring_status: Box<crate::models::PlanProMonitoringStatus>,
    #[serde(rename = "gsm_backup_status", skip_serializing_if = "Option::is_none")]
    pub gsm_backup_status: Option<Box<crate::models::PlanGsmNetworkStatus>>,
...
impl PlanCurrent {
    pub fn new(code: String, name: String, status: String, currency: String, tax_included: bool, period: String, price: i32, cvr_status: crate::models::PlanCvrStatus, emergency_status: crate::models::PlanEmergencyStatus, pro_monitoring_status: crate::models::PlanProMonitoringStatus) -> PlanCurrent {
        PlanCurrent {
            code,
            name,
            sub_name: None,
