...
pub struct UserOutputForSite {
    ...
    pub geo_fence: Option<Box<crate::models::GeoFenceOutput>>,
    ...
    #[serde(rename = "display_my_presence", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "has_individual_code", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "invited_by_displayname", skip_serializing_if = "Option::is_none")]
...
impl UserOutputForSite {
    pub fn new(present: bool, profiles: Vec<crate::models::UserSiteProfile>) -> UserOutputForSite {
        UserOutputForSite {
            present,
            geo_fence: None,
