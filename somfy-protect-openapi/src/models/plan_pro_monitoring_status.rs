...
pub struct PlanProMonitoringStatus {
    /// Service provider.
...
impl PlanProMonitoringStatus {
    pub fn new(provider: String, displayed: bool, available: bool, warning: bool) -> PlanProMonitoringStatus {
