...
pub struct DeviceOutput {
    ...
    #[serde(rename = "push_to_talk_available", skip_serializing_if = "Option::is_none")]
...
impl DeviceOutput {
    pub fn new(device_id: String, site_id: String, device_definition: crate::models::DeviceDefinition, status: crate::models::DeviceStatus) -> DeviceOutput {
        DeviceOutput {
            device_id,
            box_id: None,
            site_id,
